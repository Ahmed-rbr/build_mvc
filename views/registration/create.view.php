...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <form class="space-y-6" action="/pease/register" method="POST">
    <div>
      ...
      <?php if(isset($errs['username'])){
         ?>
                   <p class="text-red-400 text-xs mt-2"><?= $errs['username'] ?></p>
                   <?php  } ?>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      ...
      <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500"> have an acount?</a>
    </p>
  </div>
</div>
