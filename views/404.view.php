...
<section class="flex flex-col items-center justify-center h-screen text-center px-4">
    ...
    <p class="text-2xl text-gray-700 mb-6">Oops! The page you're looking for doesn't exist.</p>
    <a href="/pease/public/" class="px-6 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition">
        Go Home
    </a>
</section>
